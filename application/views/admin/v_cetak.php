...
<body>
    <div class="container">
        <div class="content-wrapper">
            <!-- Pastikan path image ini benar sesuai struktur folder Anda -->
            <img src="image/logoutama.png" style="width: 65px; height: auto; position: absolute;">
        
            <table style="width: 100%;">
                <tr>
                    <td align="center">
                        <span> KEMENTERIAN KEBUDAYAAN DAN PENDIDIKAN <br> <b> SMK NEGERI 4 BOJONEGORO </b> <br>Jalan Raya Surabaya, Sukolilo, Sukowati, Kec. Kapas, Kabupaten Bojonegoro, Jawa Timur 62181</span>
                        <hr>                    
                    </td>
                </tr>
            </table>
                        ...
                        <table border="1" cellpadding="5px" cellspacing="0px" style="font-size:11;" width="100%">
                            ...
                            <tbody style="font-size:9;">
                                ...
                                <tr align="center">
                                    ...
                                    <td><?php echo isset($d->jenis_ujian) ? $d->jenis_ujian : '-'; ?></td>
                                    <td>
                                        <?php
                                        if($d->nilai == ''){
