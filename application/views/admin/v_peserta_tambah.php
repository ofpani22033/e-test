                ...
                <form class="form-horizontal" action="" method="get">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <button type="submit" class="btn btn-custom-blue btn-flat" title="Pilih Kelas">Pilih Kelas</button>
                      </div>
                    </div>
                   </div>
                </form>
        ...
        <div class="col-md-12">
            <div class="box box-primary" style="overflow-x: scroll;">
                <form class="form-horizontal" action="<?=base_url('peserta_tambah/insert_');?>" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="date" name="tanggal" placeholder="2025-10-10" autocomplete="off" required="">
                          </div>
                      </div>
                    </div>
                  ...
                  <button type="submit" class="btn btn-custom-blue btn-flat" ><span class="fa fa-save"></span> Simpan</button>
                  </div>
                  <!-- /.box-footer -->
                </form>
            </div>
