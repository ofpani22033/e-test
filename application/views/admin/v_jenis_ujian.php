    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary" style="overflow-x: scroll;">
        <div class="box-header">
          ...
          <?php echo '<button type="button" class="btn btn-custom-blue btn-flat" data-toggle="modal" data-target="#modal-data" onclick="$(\'#modal-data-body\').load(\'' . base_url('jenis_ujian/create') . '\')"><span class="fa fa-plus"></span> Jenis Ujian</button>' ?>
        </div>
        <!-- /.box-header -->
